...
public static boolean isLoggedIn = false;
     ...
     */
    public FormUser(String nama, String level, Date hari) {
        if (!isLoggedIn) {
    ...
    private void initComponents() {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(Buku, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addComponent(Pengembalian, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void DashboardMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DashboardMouseClicked
        ...
        mainPanel.removeAll();
        mainPanel.add(new DashboardMenuUser());
        mainPanel.repaint();
    ...
    private void BukuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BukuMouseClicked
        ...
        mainPanel.removeAll();
        mainPanel.add(new MenuBukuUser());
        mainPanel.repaint();
        mainPanel.revalidate();
    ...
    private void PeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PeminjamanMouseClicked
        ...
        mainPanel.removeAll();
        mainPanel.add(new MenuPeminjamanUser());
        mainPanel.repaint();
        mainPanel.revalidate();
    ...
    private void PengembalianMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PengembalianMouseClicked
        ...
        mainPanel.removeAll();
        mainPanel.add(new MenuPengembalianUser());
        mainPanel.repaint();
        mainPanel.revalidate();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                String role = "role";
                Date date = new Date();
                new FormUser(user, role, date).setVisible(true);
            }
        });
    }
